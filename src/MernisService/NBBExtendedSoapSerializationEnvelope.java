...
public class NBBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NBBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NBBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NBBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NBBDateTimeConverter dateTimeConverter = new NBBStandardDateTimeConverter();

    public NBBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NBBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NBBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NBBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NBBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NBBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
