...
public class NBBKPSPublicSoap
{
    ...
    public NBBKPSPublicSoap(){}

    public NBBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NBBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NBBExtendedSoapSerializationEnvelope envelope= new NBBExtendedSoapSerializationEnvelope(NBBExtendedSoapSerializationEnvelope.VER11);
